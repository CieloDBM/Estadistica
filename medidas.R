...
# 1.-da la dimensión de a matriz
dim(penguins)
#344 observaciones y 9 variables
#2.-da tipo de variables
str(penguins)
#son 9 variables
#3.-nos otroga el nombre de las columnas
colnames(penguins)
#Id,especie,isla,largo pico, grosor, largoaleta, masa, genero y año
